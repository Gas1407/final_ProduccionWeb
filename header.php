...
<body>
    ...
    <header class=" container-fluid d-flex m-auto ">
        <div class="container ">
            ...
            <div class="header-logo header-logo-left pt-3">
               <a  href="index.php"><img src="img/caritas_icono.ico" width="60" height="60" alt="logo"> </a>
            </div>
        </div>
        <nav class="navbar navbar-expand-lg navbar-expand-md navbar-light m-auto" style="font-size:20px">
            <div class="container ">
              ...
              <div class="collapse navbar-collapse " id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll " style="--bs-scroll-height: 100px; ">
                  ...
                  <li class="nav-item">
                    <a class="nav-link "  href="voluntariado.php" >Voluntariado</a>
                  </li>
                  <li class="nav-item">
